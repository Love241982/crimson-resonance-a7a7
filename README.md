...
```
npm create cloudflare@latest -- --template=cloudflare/templates/crimson-resonance-a7a7
```

A live public deployment of this template is available at [https://crimson-resonance-a7a7.templates.workers.dev](https://crimson-resonance-a7a7.templates.workers.dev)
